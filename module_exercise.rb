...
###################################
  ...
  # module Perimeter #Same CamelCase naming convetions as will class - MODULES
  #   class Array
  #     def initialize
  #       @size = 400
  #     end
  ...
  #
  # #This will give an error message because we haven't defined length in the Perimeter::Array class
  # p our_array.length
...
#
#
#   user1 = Expedia::Traveller.new(name: "name", email: "email", location: Traveller.new("Seattle, Washington 98102"))
#
